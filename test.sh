...
curl -v -X POST \
  ...
  -H 'FLUENT-TAG: kube.kangoroo.go-spew-bvjsv.go-spew.31060b9db298ab166a630f828cf1cc5100a5e8feea4b5a452d3fddb7a5b4f81a' \
...
curl -v -X POST \
  ...
  -H 'content-type: application/json' \
  -H 'postman-token: a16e943a-11d4-96e5-d538-1665eb121320' \
  -H 'FLUENT-TAG: kube.kangoroo.scoffman-nginix-release-nginx-ingress-controller-d2d6b.nginx-ingress-controller.31060b9db298ab166a630f828cf1cc5100a5e8feea4b5a452d3fddb7a5b4f81a' \
  -d '[{
...
curl -v -X POST \
  ...
  -H 'FLUENT-TAG: k8s-pirate-message' \
